const AboutUs = () => {
    return (
        <div className="container mx-auto pt-28 pb-12 bg-white shadow-md rounded-md text-center">
            <h1 style={{ fontFamily: 'Dancing Script, cursive' }} className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl mb-8 drop-shadow-xl">
                Memory & diamond
            </h1>
            <div className="flex">
                <img src='/Images/aboutBg.jpg' alt="Wedding Hall" className="rounded-md h-96 mb-8" />
                <div className="px-20">
                    ...
                    <div className="flex justify-around pt-7 mt-5 border-t border-black">
